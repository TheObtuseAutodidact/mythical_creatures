...
class CentaurTest < Minitest::Test
  ...
  def test_becomes_rested_after_drinking_a_potion
    centaur = Centaur.new("Bill", "Palomino")
    centaur.drinks_potion
    refute centaur.cranky?
    assert centaur.cranky_counter == 0
    # your code here
  end
  ...
  def test_can_only_drink_potion_while_standing
    centaur = Centaur.new("Bill", "Palomino")
    centaur.lay_down
    assert_equal centaur.drinks_potion, "NO!"
    # your code here
  end

  def test_gets_sick_if_drinks_potion_while_rested
    skip
    centaur = Centaur.new("Bill", "Palimino")
    centaur.run
    centaur.drinks_potion
    assert_equal centaur.sick, true
    # your code here
    # last one not done
  end
